...
| `POST`     | `/private/charity-profile/edit/add-job`           | Private route. Sends data to the server and creates new job in the database. Will redirect to **/private/charity-profile** route.                                | {title, date, time, location, charityId}                                            |
